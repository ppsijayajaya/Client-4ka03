...
$uploadDir = '../uploads/materi/sistem_penunjang_keputusan/';
$message = "";
$failed_message = "";
$deleteMessage = "";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (move_uploaded_file($file['tmp_name'], $targetPath)) {
        ...
        $stmt = $conn->prepare("INSERT INTO sistem_penunjang_keputusan (file_name, file_path) VALUES (?, ?)");
...
if (isset($_GET['id'])) {
    ...
    // Ambil file
    $stmt = $conn->prepare("SELECT file_path FROM sistem_penunjang_keputusan WHERE id = ?");
    ...
    // Hapus dari database
    $stmt = $conn->prepare("DELETE FROM sistem_penunjang_keputusan WHERE id = ?");
    $stmt->bind_param("i", $id);
    if ($stmt->execute()) {
    ...
    // Redirect ke halaman sistem_penunjang_keputusan.php setelah file dihapus
    header("Location: sistem_penunjang_keputusan.php");
...
<head>
    ...
    <title>Materi Sistem Penunjang Keputusan</title>
    <style type="text/css">
...
<body>
    ...
    <div class="main">
        ...
        <form action="sistem_penunjang_keputusan.php" method="POST" enctype="multipart/form-data">
    <div class="upload-area" id="upload-area">
        ...
        <table border="1">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM sistem_penunjang_keputusan";
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                            ...
                            <td>
                                ...
                                <a href='sistem_penunjang_keputusan.php?id={$row['id']}'>Delete</a>
                            </td>
                        </tr>";
                        $counter++;
                    }
