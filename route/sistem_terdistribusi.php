...
$uploadDir = '../uploads/materi/sistem_terdistribusi/';
$message = "";
$failed_message = "";
$deleteMessage = "";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (move_uploaded_file($file['tmp_name'], $targetPath)) {
        ...
        $stmt = $conn->prepare("INSERT INTO sistem_terdistribusi (file_name, file_path) VALUES (?, ?)");
...
if (isset($_GET['id'])) {
    ...
    // Ambil file
    $stmt = $conn->prepare("SELECT file_path FROM sistem_terdistribusi WHERE id = ?");
    ...
    // Hapus dari database
    $stmt = $conn->prepare("DELETE FROM sistem_terdistribusi WHERE id = ?");
    $stmt->bind_param("i", $id);
    if ($stmt->execute()) {
    ...
    // Redirect ke halaman sistem_terdistribusi.php setelah file dihapus
    header("Location: sistem_terdistribusi.php");
...
<head>
    ...
    <title>Materi Sistem Terdistribusi</title>
    <style type="text/css">
...
<body>
    ...
    <div class="main">
        <h2>Sistem Terdistribusi</h2>
        <form action="sistem_terdistribusi.php" method="POST" enctype="multipart/form-data">
    <div class="upload-area" id="upload-area">
        ...
        <table border="1">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM sistem_terdistribusi";
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                            ...
                            <td>
                                ...
                                <a href='sistem_terdistribusi.php?id={$row['id']}'>Delete</a>
                            </td>
                        </tr>";
                        $counter++;
                    }
