...
$uploadDir = '../uploads/materi/pengelolaan_proyek_sistem_informasi/';
$message = "";
$failed_message = "";
$deleteMessage = "";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (move_uploaded_file($file['tmp_name'], $targetPath)) {
        ...
        $stmt = $conn->prepare("INSERT INTO pengelolaan_proyek_sistem_informasi (file_name, file_path) VALUES (?, ?)");
...
if (isset($_GET['id'])) {
    ...
    // Ambil file
    $stmt = $conn->prepare("SELECT file_path FROM pengelolaan_proyek_sistem_informasi WHERE id = ?");
    ...
    // Hapus dari database
    $stmt = $conn->prepare("DELETE FROM pengelolaan_proyek_sistem_informasi WHERE id = ?");
    $stmt->bind_param("i", $id);
    if ($stmt->execute()) {
    ...
    // Redirect ke halaman pengelolaan_proyek_sistem_informasi.php setelah file dihapus
    header("Location: pengelolaan_proyek_sistem_informasi.php");
...
<head>
    ...
    <title>Materi Pengelolaan Proyek Sistem Informasi</title>
    <style type="text/css">
...
<body>
    ...
    <div class="main">
        <h2>Pengelolaan Proyek Sistem Informasi</h2>
        <form action="pengelolaan_proyek_sistem_informasi.php" method="POST" enctype="multipart/form-data">
    <div class="upload-area" id="upload-area">
        ...
        <table border="1">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM pengelolaan_proyek_sistem_informasi";
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                            ...
                            <td>
                                ...
                                <a href='pengelolaan_proyek_sistem_informasi.php?id={$row['id']}'>Delete</a>
                            </td>
                        </tr>";
                        $counter++;
                    }
