...
$uploadDir = '../uploads/materi/Testing_Dan_Implementasi/';
$message = "";
$failed_message = "";
$deleteMessage = "";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (move_uploaded_file($file['tmp_name'], $targetPath)) {
        ...
        $stmt = $conn->prepare("INSERT INTO testing_implementasi (file_name, file_path) VALUES (?, ?)");
...
if (isset($_GET['id'])) {
    ...
    // Ambil file
    $stmt = $conn->prepare("SELECT file_path FROM testing_implementasi WHERE id = ?");
    ...
    // Hapus dari database
    $stmt = $conn->prepare("DELETE FROM testing_implementasi WHERE id = ?");
    $stmt->bind_param("i", $id);
    if ($stmt->execute()) {
    ...
    // Redirect ke halaman Testing_Dan_Implementasi.php setelah file dihapus
    header("Location: Testing_Dan_Implementasi.php");
...
<head>
    ...
    <title>Materi Testing & Implementasi</title>
    <style type="text/css">
...
<body>
    ...
    <div class="main">
        <h2>Testing & Implementasi</h2>
        <form action="Testing_Dan_Implementasi.php" method="POST" enctype="multipart/form-data">
    <div class="upload-area" id="upload-area">
        ...
        <table border="1">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM testing_implementasi";
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                            ...
                            <td>
                                ...
                                <a href='Testing_Dan_Implementasi.php?id={$row['id']}'>Delete</a>
                            </td>
                        </tr>";
                        $counter++;
                    }
